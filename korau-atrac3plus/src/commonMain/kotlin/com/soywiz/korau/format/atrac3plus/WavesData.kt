...
class WavesData {
	internal var pendEnv: WaveEnvelope = WaveEnvelope() ///< pending envelope from the previous frame
	internal var currEnv: WaveEnvelope = WaveEnvelope() ///< group envelope from the current frame
