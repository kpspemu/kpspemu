...
import com.soywiz.kpspemu.util.parseInt
...
object LibDoc {
	...
	data class Library(val name: String, val flags: Int, val functions: ArrayList<Function> = arrayListOf(), val variables: ArrayList<Variable> = arrayListOf())
