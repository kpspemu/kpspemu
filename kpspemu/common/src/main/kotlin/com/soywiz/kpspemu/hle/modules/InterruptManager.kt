...
class InterruptManager(emulator: Emulator) : SceModule(emulator, "InterruptManager", 0x40000011, "interruptman.prx", "sceInterruptManager") {
	...
	fun sceKernelRegisterSubIntrHandler(thread: PspThread, interrupt: Int, handlerIndex: Int, callbackAddress: Int, callbackArgument: Int): Int {
	...
	override fun registerModule() {
		registerFunctionInt("sceKernelRegisterSubIntrHandler", 0xCA04A2B9, since = 150) { sceKernelRegisterSubIntrHandler(thread, int, int, int, int) }
