...
import com.soywiz.kpspemu.util.SmallCompanion2
...
class sceSasCore(emulator: Emulator) : SceModule(emulator, "sceSasCore", 0x40010011, "sc_sascore.prx", "sceSAScore") {
	...
	private fun getVoice(sas: Int, voiceId: Int): Voice = this.core.voices.getOrNull(voiceId) ?: sceKernelException(SceKernelErrors.ERROR_SAS_INVALID_VOICE)
	...
	fun __sceSasSetVolume(sas: Int, voice: Int, leftVolume: Int, rightVolume: Int, effectLeftVolume: Int, effectRightVolume: Int): Int {
	...
	fun __sceSasSetSL(sas: Int, voice: Int, level: Int): Int = 0.apply { getVoice(sas, voice).envelope.sustainLevel = level }
	...
	fun __sceSasSetSteepWave(sas: Int, voice: Int, steepWave: Int): Int = 0.apply { getVoice(sas, voice).steepWave = steepWave }
	fun __sceSasSetADSRmode(sas: Int, voice: Int, flag: Int, attackType: Int, decayType: Int, sustainType: Int, releaseType: Int): Int {
	...
	override fun registerModule() {
		...
		registerFunctionInt("__sceSasSetVolume", 0x440CA7D8, since = 150) { __sceSasSetVolume(int, int, int, int, int, int) }
		...
		registerFunctionInt("__sceSasGetAllEnvelopeHeights", 0x07F58C24, since = 150) { __sceSasGetAllEnvelopeHeights(int, ptr32) }
		...
		registerFunctionInt("__sceSasGetEnvelopeHeight", 0x74AE582A, since = 150) { __sceSasGetEnvelopeHeight(int, int) }
		...
		registerFunctionInt("__sceSasSetADSRmode", 0x9EC3676A, since = 150) { __sceSasSetADSRmode(int, int, int, int, int, int, int) }
		registerFunctionInt("__sceSasSetTrianglarWave", 0xA232CBE6, since = 150) { __sceSasSetTrianglarWave(int, int, int) }
		...
		registerFunctionInt("__sceSasSetSimpleADSR", 0xCBCD4F79, since = 150) { __sceSasSetSimpleADSR(int, int, int, int) }
		...
		registerFunctionInt("__sceSasSetVoicePCM", 0xE1CD9561, since = 150) { __sceSasSetVoicePCM(int, int, ptr, int, int) }
