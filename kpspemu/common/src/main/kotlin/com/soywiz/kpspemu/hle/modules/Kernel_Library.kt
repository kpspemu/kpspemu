...
class Kernel_Library(emulator: Emulator) : SceModule(emulator, "Kernel_Library", 0x00010011, "usersystemlib.prx", "sceKernelLibrary") {
	...
	override fun registerModule() {
		...
		registerFunctionRaw("sceKernelCpuResumeIntrWithSync", 0x3B84732D, since = 150) { sceKernelCpuResumeIntrWithSync(it) }
