...
class scePower(emulator: Emulator) : SceModule(emulator, "scePower", 0x40010011, "power.prx", "scePower_Service") {
	...
	override fun registerModule() {
		...
		registerFunctionFloat("scePowerGetCpuClockFrequencyFloat", 0xB1A52C83, since = 150) { scePowerGetCpuClockFrequencyFloat() }

		registerFunctionInt("scePowerGetPllClockFrequencyInt", 0x34F9C463, since = 150) { scePowerGetPllClockFrequencyInt() }
		registerFunctionFloat("scePowerGetPllClockFrequencyFloat", 0xEA382A27, since = 150) { scePowerGetPllClockFrequencyFloat() }

		registerFunctionInt("scePowerGetBusClockFrequency", 0x478FE6F5, since = 150) { scePowerGetBusClockFrequency() }
		registerFunctionInt("scePowerGetBusClockFrequencyInt", 0xBD681969, since = 150) { scePowerGetBusClockFrequencyInt() }
		registerFunctionFloat("scePowerGetBusClockFrequencyFloat", 0x9BADB3EB, since = 150) { scePowerGetBusClockFrequencyFloat() }
