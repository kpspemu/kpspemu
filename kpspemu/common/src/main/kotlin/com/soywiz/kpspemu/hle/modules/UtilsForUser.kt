...
class UtilsForUser(emulator: Emulator) : SceModule(emulator, "UtilsForUser", 0x40010011, "sysmem.prx", "sceSystemMemoryManager") {
	...
	fun sceKernelIcacheInvalidateRange(cpu: CpuState): Unit = UNIMPLEMENTED(0xC2DF770E)
	...
	override fun registerModule() {
		...
		registerFunctionRaw("sceKernelIcacheInvalidateRange", 0xC2DF770E, since = 150) { sceKernelIcacheInvalidateRange(it) }
