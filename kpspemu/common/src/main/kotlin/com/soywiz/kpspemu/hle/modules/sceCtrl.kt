...
class sceCtrl(emulator: Emulator) : SceModule(emulator, "sceCtrl", 0x40010011, "ctrl.prx", "sceController_Service") {
	...
	fun sceCtrlReadBufferPositive(cpu: CpuState): Unit = UNIMPLEMENTED(0x1F803938)
	...
	override fun registerModule() {
		...
		registerFunctionRaw("sceCtrlReadBufferPositive", 0x1F803938, since = 150) { sceCtrlReadBufferPositive(it) }
