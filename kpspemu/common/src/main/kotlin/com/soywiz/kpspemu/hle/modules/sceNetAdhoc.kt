...
class sceNetAdhoc(emulator: Emulator) : SceModule(emulator, "sceNetAdhoc", 0x00010011, "pspnet_adhoc.prx", "sceNetAdhoc_Library") {
	...
	override fun registerModule() {
		registerFunctionRaw("sceNetAdhocGameModeDeleteReplica", 0x0B2228E9, since = 150) { sceNetAdhocGameModeDeleteReplica(it) }
		registerFunctionRaw("sceNetAdhocPtpClose", 0x157E6225, since = 150) { sceNetAdhocPtpClose(it) }
		registerFunctionRaw("sceNetAdhocGameModeCreateReplica", 0x3278AB0C, since = 150) { sceNetAdhocGameModeCreateReplica(it) }
		...
		registerFunctionRaw("sceNetAdhocGameModeCreateMaster", 0x7F75C338, since = 150) { sceNetAdhocGameModeCreateMaster(it) }
		...
		registerFunctionRaw("sceNetAdhocGameModeUpdateMaster", 0x98C204C8, since = 150) { sceNetAdhocGameModeUpdateMaster(it) }
		...
		registerFunctionRaw("sceNetAdhocGameModeDeleteMaster", 0xA0229362, since = 150) { sceNetAdhocGameModeDeleteMaster(it) }
		...
		registerFunctionRaw("sceNetAdhocGameModeUpdateReplica", 0xFA324B4E, since = 150) { sceNetAdhocGameModeUpdateReplica(it) }
