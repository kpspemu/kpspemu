...
class sceNetAdhocctl(emulator: Emulator) : SceModule(emulator, "sceNetAdhocctl", 0x00010011, "pspnet_adhocctl.prx", "sceNetAdhocctl_Library") {
	...
	override fun registerModule() {
		...
		registerFunctionRaw("sceNetAdhocctlJoinEnterGameMode", 0x1FF89745, since = 150) { sceNetAdhocctlJoinEnterGameMode(it) }
		...
		registerFunctionRaw("sceNetAdhocctlGetGameModeInfo", 0x5A014CE0, since = 150) { sceNetAdhocctlGetGameModeInfo(it) }
		...
		registerFunctionRaw("sceNetAdhocctlCreateEnterGameMode", 0xA5C055CE, since = 150) { sceNetAdhocctlCreateEnterGameMode(it) }
