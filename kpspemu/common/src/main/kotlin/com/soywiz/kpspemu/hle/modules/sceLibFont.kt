...
class sceLibFont(emulator: Emulator) : SceModule(emulator, "sceLibFont", 0x00010000, "libfont_hv.prx", "sceFont_Library_HV") {
	...
	override fun registerModule() {
		...
		registerFunctionRaw("sceFontGetFontInfoByIndexNumber", 0x5333322D, since = 150) { sceFontGetFontInfoByIndexNumber(it) }
		...
		registerFunctionRaw("sceFontGetShadowGlyphImage_Clip", 0x5DCF6858, since = 150) { sceFontGetShadowGlyphImage_Clip(it) }
		...
		registerFunctionRaw("sceFontGetCharGlyphImage_Clip", 0xCA1E6945, since = 150) { sceFontGetCharGlyphImage_Clip(it) }
