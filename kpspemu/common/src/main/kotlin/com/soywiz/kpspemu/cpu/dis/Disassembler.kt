...
object Disassembler : InstructionDecoder() {
	...
	fun disasm(pc: Int, i: Int, nameProvider: NameProvider = DummyNameProvider): String = disasm(InstructionOpcodeDecoder(i), pc, i, nameProvider)
...
fun Memory.disasm(pc: Int, nameProvider: NameProvider = DummyNameProvider): String = Disassembler.disasm(pc, this.lw(pc), nameProvider)
...
fun Memory.printInstructionAt(address: Int, nameProvider: NameProvider = DummyNameProvider) = Console.error(getPrintInstructionAt(address, nameProvider))
