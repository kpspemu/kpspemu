...
inline class CpuRegisters(val data: IntPointer)

fun CpuRegisters(): CpuRegisters = CpuRegisters(NewIntPointer(512)).apply { init() }

// 0-32
inline var CpuRegisters.IR: InstructionRegister get() = InstructionRegister(data[0]); set(value) { data[0] = value.data }
...
inline var CpuRegisters.VFPR_CC: Int get() = getVfprC(CpuState.VFPU_CTRL.CC); set(value) = run { setVfprC(CpuState.VFPU_CTRL.CC, value) }
...
inline var CpuRegisters.fcr31_rm: Int set(value) = run { fcr31 = fcr31.insert(value, 0, 2) }; get() = fcr31.extract(0, 2)
inline var CpuRegisters.fcr31_2_21: Int set(value) = run { fcr31 = fcr31.insert(value, 2, 21) }; get() = fcr31.extract(2, 21)
inline var CpuRegisters.fcr31_cc: Boolean set(value) = run { fcr31 = fcr31.insert(value, 23) }; get() = fcr31.extract(23)
inline var CpuRegisters.fcr31_fs: Boolean set(value) = run { fcr31 = fcr31.insert(value, 24) }; get() = fcr31.extract(24)
inline var CpuRegisters.fcr31_25_7: Int set(value) = run { fcr31 = fcr31.insert(value, 25, 7) }; get() = fcr31.extract(25, 7)
...
inline var CpuRegisters.r0: Int; set(value) = run { }; get() = 0
